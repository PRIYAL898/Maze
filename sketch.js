...
function setup(){
    ...
    block19 = createSprite(130,490,60,6);
    block19.shapeColor="green";
    
    block20 = createSprite(160,410,6,155);
    ...
    block23 = createSprite(50,180,6,100);
    block23.shapeColor="green";

    block24 = createSprite(130,230,150,6);
...
function draw(){
    ...
    if(guard1.isTouching(edges[0])){
        guard1.velocityY=3;
    }

    if(guard1.isTouching(edges[1])){
        guard1.velocityX=-3;
    }
    if(guard1.isTouching(edges[2])){
        guard1.velocityY=-3;
    }
    if(guard1.isTouching(edges[3])){
        guard1.velocityX=3;
    }
